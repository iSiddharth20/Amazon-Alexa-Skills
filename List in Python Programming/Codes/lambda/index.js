...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, ask me to tell you Something about Oython List or some facts about List in Python. Which would you like to try?';
...
const PythonListIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'PythonListIntent';
    },
    handle(handlerInput) {
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'You can say Tell me Something about Python List or Some facts about List in Python ';

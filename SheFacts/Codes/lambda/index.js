...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, ask me to tell you somehing about Girls or What do I know about female mind. Which would you like to try?';
...
const SheFactsIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'SheFactsIntent';
    },
    handle(handlerInput) {
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'You can say what do you know about female mind or what is about girls that boys dont understand.';
